...
public final class Main {
	...
	public static void main(String[] args) throws IOException {
		try {
			...
			// SERVICE: HELP
			ChannelService helpService = new HelpService(
					HELP_SERVICE,
			...
			channelMessageListener.addPropertyChangeListener(PROP_SERVICE_REGISTRATION_EVENT, helpService);
			helpService.addPropertyChangeListener(PROP_COMMAND_REGISTRATION_EVENT, channelMessageListener);
			...
			helpService.addPropertyChangeListener(PROP_SERVICE_REGISTRATION_EVENT, helpServicesCommand);
			...
			miscService.addPropertyChangeListener(PROP_COMMAND_REGISTRATION_EVENT, channelMessageListener);
